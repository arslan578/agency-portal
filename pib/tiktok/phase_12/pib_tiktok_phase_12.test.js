...
const phase12 = require("./pib_tiktok_phase_12");
...
const BASE_INPUT = {
    execution_id: "exec-1",
    phase: "PIB_TIKTOK_PHASE_12",
    feature_flags: { FF_PIB_TIKTOK_PHASE_12: true },
...
describe("PIB TikTok Phase 12: Connector Readiness Certificate", () => {
    ...
    test("5. Feature flag OFF -> NO_OP", () => {
        const input = deepCopy(BASE_INPUT);
        input.feature_flags.FF_PIB_TIKTOK_PHASE_12 = false;
        const result = phase12.execute(input);

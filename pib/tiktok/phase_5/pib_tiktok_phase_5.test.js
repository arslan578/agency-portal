const { execute } = require("./pib_tiktok_phase_5");
...
const BASE_INPUT = {
    ...
    phase: "PIB_TIKTOK_PHASE_5",
    feature_flags: { FF_PIB_TIKTOK_PHASE_5: true },
    ...
    io_surface: {
        routing: {
            default_endpoint: "https://ads.tiktok.com/open_api", // TikTok specific default? Or just structural example? Using generic/modified URL for clarity it's NOT Google.
...
describe("PIB-TIKTOK-PHASE-5", () => {
    ...
    describe("Happy Path", () => {
        test("1. Produces routing_profile with correct structures", () => {
            ...
            expect(result.routing_profile.default_endpoint).toBe("https://ads.tiktok.com/open_api");
    ...
    describe("Negative Path", () => {
        test("10. Missing validator_image -> ERROR", () => {
        ...
        test("11. Missing io_surface -> ERROR", () => {
        ...
        test("12. Missing routing object -> ERROR", () => {
        ...
        test("13. Missing retry_logic -> ERROR", () => {
            const input = JSON.parse(JSON.stringify(BASE_INPUT));
        ...
        test("16. INVALID_INPUT for null", () => {
        ...
        test("Feature flag false -> NO_OP", () => {
            const input = { ...BASE_INPUT, feature_flags: { FF_PIB_TIKTOK_PHASE_5: false } };
            const result = execute(input);

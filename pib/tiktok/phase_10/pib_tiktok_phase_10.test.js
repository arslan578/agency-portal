...
const phase10 = require("./pib_tiktok_phase_10");
...
const BASE_ENVELOPE_SHAPE = {
    ...
    connector_id: "tiktok_ads", // Mirrors google_ads
    tenant_id: "t1",
    execution_id: "exec-1",
    phase: "PIB_TIKTOK_PHASE_10",
...
const BASE_INPUT = {
    execution_id: "exec-1",
    feature_flags: { FF_PIB_TIKTOK_PHASE_10: true },
    recorder_schema: {
...
describe("PIB TikTok Phase 10: Replay Grounding & Execution Validation", () => {
    ...
    test("22. Flag OFF -> NO_OP", () => {
        let input = deepCopy(BASE_INPUT);
        input.feature_flags.FF_PIB_TIKTOK_PHASE_10 = false;
        const result = phase10.execute(input);

const phase10 = require("./pib_google_phase_10");
...
const BASE_INPUT = {
    execution_id: "exec-1",
    feature_flags: { FF_PIB_GOOGLE_PHASE_10: true },
    recorder_schema: {
...
describe("PIB Google Phase 10: Replay Grounding & Execution Validation", () => {
    ...
    test("22. Flag OFF -> NO_OP", () => {
        let input = deepCopy(BASE_INPUT);
        input.feature_flags.FF_PIB_GOOGLE_PHASE_10 = false;
        const result = phase10.execute(input);

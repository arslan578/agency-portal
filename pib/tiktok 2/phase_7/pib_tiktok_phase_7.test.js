const { execute } = require("./pib_tiktok_phase_7");
...
const BASE_INPUT = {
    ...
    phase: "PIB_TIKTOK_PHASE_7",
    feature_flags: { FF_PIB_TIKTOK_PHASE_7: true },
...
describe("PIB-TIKTOK-PHASE-7", () => {
    ...
    describe("Negative Path", () => {
        ...
        test("Feature flag false -> NO_OP", () => {
            const input = { ...BASE_INPUT, feature_flags: { FF_PIB_TIKTOK_PHASE_7: false } };
            const result = execute(input);
            expect(result.status).toBe("NO_OP");
        });

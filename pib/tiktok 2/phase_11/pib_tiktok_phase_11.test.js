...
const phase11 = require("./pib_tiktok_phase_11");
...
const BASE_INPUT = {
    execution_id: "exec-1",
    phase: "PIB_TIKTOK_PHASE_11",
    feature_flags: { FF_PIB_TIKTOK_PHASE_11: true },
...
describe("PIB TikTok Phase 11: Activation Checkpoint", () => {
    ...
    test("2. Feature flag off -> NO_OP", () => {
        const input = deepCopy(BASE_INPUT);
        input.feature_flags.FF_PIB_TIKTOK_PHASE_11 = false;
        const result = phase11.execute(input);

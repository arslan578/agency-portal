const phase11 = require("./pib_meta_phase_11");
...
const BASE_INPUT = {
    execution_id: "exec-1",
    phase: "PIB_META_PHASE_11", // Meta
    feature_flags: { FF_PIB_META_PHASE_11: true }, // Meta flag
    ...
    replay_validation_record: {
        ...
        // counterfactual_blueprint required if safe=false
        audit_ledger_entry: {}
    }
};

describe("PIB Meta Phase 11: Activation Checkpoint", () => {
    ...
    test("2. Feature flag off -> NO_OP", () => {
        const input = deepCopy(BASE_INPUT);
        input.feature_flags.FF_PIB_META_PHASE_11 = false;
        const result = phase11.execute(input);

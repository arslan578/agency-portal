/**
 * PIB-META-PHASE-10: Replay Grounding & Execution Validation
 *
...
// --- CONSTANTS ---
const PHASE_ID = "PIB_META_PHASE_10";
const OUTPUT_VERSION = "pib_meta_phase_10_output_v1";
...
function validateInput(input) {
    ...
    // Check Feature Flag
    if (input.feature_flags && input.feature_flags.FF_PIB_META_PHASE_10 === false) {
        return "NO_OP";
    }
...
function execute(input) {
    ...
    const grounding_snapshot = {
        ...
        envelope_binding: {
            connector_id: envShape.connector_id, // "meta_ads"

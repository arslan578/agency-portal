      ...
      <main className="flex-1 overflow-auto p-6 space-y-5">
        ...
        <section className="bg-white rounded-xl border border-border p-4">
          <div className="flex flex-wrap items-center gap-3">
            <select
              className="h-[40px] px-3 border border-border rounded-[10px] bg-surface-secondary text-[13px] text-text-primary"
              value={clientFilter}
        ...
        <section className="bg-white rounded-xl border border-border overflow-hidden">
          <header className="px-5 py-4 border-b border-border-subtle bg-surface-secondary/50">
            <h2 className="text-[14px] font-bold text-text-primary">Campaign Status Overview</h2>
            ...
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-border-subtle bg-surface-secondary/50">
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Campaign</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Status</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Budget</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Platform</th>
                </tr>
              </thead>
              <tbody>
                {filteredCampaigns.length === 0 ? (
                  ...
                  filteredCampaigns.map((c) => (
                    <tr key={c.id} className="border-b border-border last:border-b-0 hover:bg-cream-dark/20">
        ...
        <section className="bg-white rounded-xl border border-border overflow-hidden">
          <header className="px-5 py-4 border-b border-border-subtle bg-surface-secondary/50">
            <h2 className="text-[14px] font-bold text-text-primary">Selected Campaign Report</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-border-subtle bg-surface-secondary/50">
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Date</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Platform</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Impressions</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Clicks</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Spend</th>
                  <th className="px-5 py-3 font-semibold text-text-muted uppercase text-[11px] tracking-wide">Conversions</th>
                </tr>
              </thead>
              <tbody>
                {reports.length === 0 ? (
                  ...
                  reports.map((row, idx) => (
                    <tr key={`${row.date}-${row.platform}-${idx}`} className="border-b border-border last:border-b-0 hover:bg-cream-dark/20">

  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-white p-8">
      <div className="w-full max-w-[420px] text-center">
        ...
        <h1 className="text-[22px] font-extrabold text-text-primary mb-3">Your session has expired</h1>
        ...
        <div className="pt-2 space-y-3">
          <a
            href="/login"
            className="inline-block w-full py-[13px] bg-teal hover:bg-teal-dark text-white font-extrabold text-[14px] rounded-[10px] transition-colors text-center no-underline"
          >
            Back to Sign In
          </a>

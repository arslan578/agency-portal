                ...
                <div className="flex flex-col gap-[6px] mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full py-[11px] px-[14px] pr-[42px] border rounded-[10px] text-[14px] font-medium text-text-primary bg-white placeholder:text-text-muted focus:outline-none focus:border-teal-deep transition-colors ${loginError ? 'border-red' : 'border-border'}`}

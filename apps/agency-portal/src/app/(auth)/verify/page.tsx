      ...
      <div className="w-full max-w-[420px] text-center">
        ...
        {state.status === 'loading' && (
          <div className="space-y-4">
            ...
            <h1 className="text-[22px] font-bold text-text-primary">Verifying your invite...</h1>
        ...
        {state.status === 'success' && (
          <div className="space-y-4">
            ...
            <h1 className="text-[22px] font-bold text-text-primary">You&apos;re in!</h1>
        ...
        {state.status === 'error' && (
          <div className="space-y-5">
            ...
            {state.code === 'used' && (
              <>
                <h1 className="text-[22px] font-bold text-text-primary">Link already used</h1>
            ...
            {state.code === 'expired' && (
              <>
                <h1 className="text-[22px] font-bold text-text-primary">Link expired</h1>
                <p className="text-[14px] text-text-muted font-medium leading-relaxed">
            ...
            {(state.code === 'invalid' || state.code === 'unknown') && (
              <>
                <h1 className="text-[22px] font-bold text-text-primary">Verification failed</h1>
                <p className="text-[14px] text-text-muted font-medium leading-relaxed">
                  {state.message}
                </p>
              </>
